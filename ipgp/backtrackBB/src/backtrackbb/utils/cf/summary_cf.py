...
def summary_cf_station_wave(
    ...
    MBfilter_CF_kwargs = {
        ...
        "rosenberger_filter_threshold": config.rosenberger_filter_threshold,
        "rosenberger_normalize_each": config.rosenberger_normalize_each,
        "wave_type": wave_type,
