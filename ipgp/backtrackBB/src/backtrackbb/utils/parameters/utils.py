...
def create_parser():
    ...
    parser.add_argument(
        "studycase", type=str, help="Case to study (e.g. synthetic, vrancea)"
    )
    parser.add_argument("datadir", type=str, help="Input data directory base")
    ...
    parser.add_argument("day_start", type=int, help="Starting day")
    parser.add_argument("day_end", type=int, help="Ending day")
    parser.add_argument("hour_start", type=int, help="Starting hour")
    parser.add_argument("hour_end", type=int, help="Ending hour")
    parser.add_argument("tw_x_task", type=int, help="Time windows per task")
    return parser
