...
from backtrackbb.libs.names import get_lib_path
...
def get_transform(
    ...
    if trans_type == "SIMPLE":
        s = "SIMPLE %s %s %s" % (orig_lat, orig_lon, map_rot)
...
if __name__ == "__main__":
    ...
    std_par2 = 52.0
    rot = 0.0
    get_transform("LAMBERT", lat0, lon0, std_par1, std_par2, rot, "Clarke-1880")
